...
7.  **Kalıcı Oturum Yönetimi (`core/session_manager_persistent.py`):** Oturum bilgilerini, kullanıcı kimlik doğrulamalarını ve konuşma bağlamlarını SQLite üzerinde thread-safe ve TTL (Time-To-Live) süresine bağlı olarak kalıcı tutar.
