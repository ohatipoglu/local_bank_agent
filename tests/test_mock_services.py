...
class TestMockAuthService:
    ...
    def test_verify_valid_customer(self, auth_service):
        ...
        assert auth_service.verify_customer("12345678901") is True
        assert auth_service.verify_customer("98765432109") is True
    ...
    def test_get_customer_info_existing(self, auth_service):
        ...
        info = auth_service.get_customer_info("12345678901")
        assert info is not None
        assert info["first_name"] == "Ahmet"
        assert info["last_name"] == "Yılmaz"
        assert info["tc_kimlik"] == "12345678901"
