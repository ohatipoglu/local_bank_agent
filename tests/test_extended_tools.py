...
class TestTransactionHistory:
    ...
    def test_get_transaction_history(self):
        ...
        result = txn_tool.run(customer_id="12345678901", limit=5)
    ...
    def test_get_transaction_history_no_service(self):
        ...
        result = txn_tool.run(customer_id="12345678901")
...
class TestListAccounts:
    ...
    def test_list_accounts(self):
        ...
        result = accounts_tool.run(customer_id="12345678901")
...
class TestPayCreditCard:
    ...
    def test_pay_credit_card_full(self):
        ...
        result = pay_tool.run(customer_id="12345678901", amount=None)
    ...
    def test_pay_credit_card_partial(self):
        ...
        # Pay partial amount
        result = pay_tool.run(customer_id="12345678901", amount=1000.0)
    ...
    def test_pay_credit_card_no_debt(self):
        ...
        result = pay_tool.run(customer_id="12345678901")
    ...
    def test_pay_credit_card_overpay(self):
        ...
        result = pay_tool.run(customer_id="12345678901", amount=2000.0)
    ...
    def test_pay_credit_card_invalid_amount(self):
        ...
        result = pay_tool.run(customer_id="12345678901", amount=-100.0)
        assert isinstance(result, str)
